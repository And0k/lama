...
class TestPreprocessing:
    ...
    def test_log_transform(self):
        from hydro_lama_nc.data.preprocessing import LogTransform
    ...
    def test_sqrt_transform(self):
        from hydro_lama_nc.data.preprocessing import SqrtTransform
        t = SqrtTransform()
    ...
    def test_power_transform(self):
        from hydro_lama_nc.data.preprocessing import PowerTransform
    ...
    def test_depth_dependent_scaling(self):
        from hydro_lama_nc.data.preprocessing import DepthDependentScaling
    ...
    def test_build_transform_from_string(self):
        from hydro_lama_nc.data.preprocessing import build_transform
    ...
    def test_pipeline_from_config(self):
        from hydro_lama_nc.data.preprocessing import PreprocessingPipeline
...
class TestMultiFile:
    ...
    def test_scan_time_coordinates(self, tmp_path):
        from hydro_lama_nc.data.multi_file import scan_time_coordinates
    ...
    def test_align_time_coordinates_no_overlap(self, tmp_path):
        from hydro_lama_nc.data.multi_file import scan_time_coordinates, align_time_coordinates
        f1 = _make_nc(tmp_path / "f1.nc", ["thetao"], shape=(3, 5, 8, 10), time_offset=0)
        f2 = _make_nc(tmp_path / "f2.nc", ["thetao"], shape=(3, 5, 8, 10), time_offset=3)
        info = scan_time_coordinates([str(f1), str(f2)])
    ...
    def test_multi_file_dataset_length(self, tmp_path):
        from hydro_lama_nc.data.multi_file import MultiFileNetCDFDataset
        f1 = _make_nc(tmp_path / "f1.nc", ["thetao"], shape=(3, 5, 8, 10), time_offset=0)
        f2 = _make_nc(tmp_path / "f2.nc", ["thetao"], shape=(3, 5, 8, 10), time_offset=3)
...
class TestCoordinates:
    ...
    def test_detect_regular(self, tmp_path):
        from hydro_lama_nc.data.coordinates import detect_coordinate_system
    ...
    def test_rotated_to_regular(self):
        from hydro_lama_nc.data.coordinates import rotated_to_regular
    ...
    def test_build_regridder(self, tmp_path):
        from hydro_lama_nc.data.coordinates import build_regridder
    ...
    def test_regrid_dataset(self, tmp_path):
        from hydro_lama_nc.data.coordinates import regrid_dataset
