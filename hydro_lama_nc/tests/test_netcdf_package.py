...
from hydro_lama_nc.data.loader import load_netcdf, get_available_variables, get_variable_info
from hydro_lama_nc.data.slicer import slice_nc
from hydro_lama_nc.mask_generator import generate_mask, generate_masks_for_batch
from hydro_lama_nc.data.dataset import NetCDFDataset, _resolve_axis_count
from hydro_lama_nc.visualization import plot_slice, plot_mask, plot_comparison
...
class TestNetCDFDataset:
    ...
    def test_resolve_axis_count(self):
        from hydro_lama_nc.data.dataset import _resolve_axis_count
        shape = (2, 4, 8, 10)
...
class TestVerticalMasks:
    ...
    def test_vertical_random_lines_mask_shape(self):
        from hydro_lama_nc.data.vertical_masks import vertical_random_lines_mask
    ...
    def test_add_model_points_shape(self):
        from hydro_lama_nc.data.vertical_masks import add_model_points
    ...
    def test_generate_vertical_mask(self):
        from hydro_lama_nc.data.vertical_masks import generate_vertical_mask
